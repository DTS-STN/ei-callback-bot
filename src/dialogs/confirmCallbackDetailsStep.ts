...
export class ConfirmCallbackDetailsStep extends ComponentDialog {
    constructor() {
        ...
        this.addDialog(new WaterfallDialog(CONFIRM_CALLBACK_DETAILS_STEP_WATERFALL_STEP, [
...
*/
     ...
     //   const intent = LuisRecognizer.topIntent(recognizerResult, 'None', 0.50);
        ...
        default: {
            ...
            return await stepContext.replaceDialog(CONFIRM_CALLBACK_DETAILS_STEP, callbackBotDetails);
        }
        }
    }
}
