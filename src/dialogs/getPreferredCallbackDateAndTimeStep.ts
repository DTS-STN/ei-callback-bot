...
export const GET_PREFERRED_CALLBACK_DATE_AND_TIME_STEP = 'GET_PREFERRED_CALLBACK_DATE_AND_TIME_STEP';
...
export class GetPreferredCallbackDateAndTimeStep extends ComponentDialog {
    constructor() {
        ...
        this.addDialog(new WaterfallDialog(GET_PREFERRED_CALLBACK_DATE_AND_TIME_WATERFALL_STEP, [
    ...
    async initialStep(stepContext) {
        ...
        if (callbackBotDetails.getPreferredCallbackDateAndTimeStep === null || callbackBotDetails.getPreferredMethodOfContactStep === -1) {
            ...
            const promptOptions: any = i18n.__('getPreferredCallbackDateAndTimeStepStandardPromptOptions');
     ...
     async dateStep(stepContext: WaterfallStepContext<CallbackBotDetails>) {
      // WaterfallStep always finishes with the end of the Waterfall or with another dialog; here it is a Prompt Dialog.
        ...
        return await stepContext.prompt(CHOICE_PROMPT, {
            choices: ChoiceFactory.toChoices([' Sep 1 2021', 'Spe 4 2021', 'Sep 19 2021']),
...
*/
      ...
      //  const recognizerResult = await recognizer.recognize(stepContext.context);
        ...
        const sendDateAndTimeMsg = i18n.__('getPreferredCallbackDateAndTimeStepConfirmMsg');
      ...
      const intent:string = 'dateTime'
        ...
        default: {
            ...
            return await stepContext.replaceDialog(GET_PREFERRED_CALLBACK_DATE_AND_TIME_STEP, callbackBotDetails);
        }
        }
    }
}
